            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a class="J_menuItem" href="adminInfo">个人资料</a>
                            </li>
                            <li class="divider"></li>
                ...
                <li>
                    <a href="#">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a class="J_menuItem" href="selectStudent">学生列表</a>
                            </li>
                        </ul>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <i class="fa fa-home"></i>
                        <span class="nav-label">教师信息管理</span>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a class="J_menuItem" href="adminLookTeacher">教师列表</a>
                            </li>
                        </ul>
                    </a>
                </li>
                <li>
                    <a href="#">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a class="J_menuItem" href="adminLookClasses">班级列表</a>
                            </li>
                            <li><a class="J_menuItem" href="adminLookCourse">课程列表</a>
                            </li>
                            <li><a class="J_menuItem" href="arrangeCourse">课程安排</a>
                            </li>
                        </ul>
                    </a>
                </li>
				<li>
                    <a href="#">
                        <i class="fa fa-home"></i>
                        <span class="nav-label">系统信息管理</span>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a class="J_menuItem" href="adminLookUser">用户信息</a>
                            </li>
                        </ul>
                    </a>
                </li>
