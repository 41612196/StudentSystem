            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                               <span class="block m-t-xs"><strong class="font-bold"> 教师 </strong></span>
                                <span class="text-muted text-xs block">个人管理<b class="caret"></b></span>
                                </span>
                        </a>
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a class="J_menuItem" href="/teacherInfo">个人资料</a>
                            </li>
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="nav-label" >学生成绩管理</span>
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
						    <li><a class="J_menuItem" href="teacherSelectScore">查询成绩</a>
                            </li>
                            <li><a class="J_menuItem" href="addScore">录入成绩</a>
                            </li>
							<li><a class="J_menuItem" href="/jsp/teacher/analyzeScore.jsp">成绩分析</a>
                            </li>
                        </ul>
                    </a>
                </li>
