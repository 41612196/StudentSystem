...
<div class="result-wrap">
    ...
    <div class="result-content" style="display: inline-block;width: 600px;height: 600px">

        <ul class="sys-info-list">
            <li style="margin-top: 20px">
                <label class="res-lab">照片：</label><br><img class="res-lab"
                                                           style="width: 120px ;height: 150px;margin-left: 140px"
                                                           src="../..<%=teacher.getPhoto()%>"/>
                <form method="post" action="/UploadServlet" enctype="multipart/form-data"
                    ...
                    <div style="display: inline-block">
                        <input type="submit" value="上传" class="btn-info" style="display: inline-block">
                    </div>
                </form>
            </li>
            <li style="margin-top: 20px">
                <label class="res-lab">工号：</label><span class="res-info"><%=teacher.getTeacherId()%></span>
            </li>
            <li style="margin-top: 20px">
                <label class="res-lab">姓名：</label><span class="res-info"><%=teacher.getTeacherName()%></span>
            </li>
            <li style="margin-top: 20px">
                <label class="res-lab">性别：</label><span class="res-info"><%=teacher.getSex()%></span>
            </li>
            <li style="margin-top: 20px">
                <label class="res-lab">学院：</label><span class="res-info"><%=teacher.getCollege()%></span>
            </li>
            <li style="margin-top: 20px">
                <label class="res-lab">职称：</label><span class="res-info"><%=teacher.getProfessionalTitle()%></span>
            </li>
            <li style="margin-top: 20px">
                <label class="res-lab">学位：</label><span class="res-info"><%=teacher.getDegree()%></span>
            </li>
        </ul>
    </div>
    <div id="clock" style="width: 500px;height:500px;display:inline-block"></div>
    <script>
